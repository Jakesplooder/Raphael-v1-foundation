...
class ServiceModule(abc.ABC):
    ...
    @abc.abstractmethod
    def name(self) -> str:
        """The unique registry name for this service."""
        pass
    
    @property
    def depends_on(self) -> list[str]:
        """A list of service names this module depends on. Used for DAG boot computation."""
        return []
    ...
    async def heartbeat(self) -> bool:
        """Return True if the module is internally alive and functioning."""
        pass
