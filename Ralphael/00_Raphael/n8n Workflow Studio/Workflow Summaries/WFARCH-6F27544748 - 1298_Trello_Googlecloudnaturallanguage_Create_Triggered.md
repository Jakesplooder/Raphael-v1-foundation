# Archived n8n Workflow WFARCH-6F27544748
...
1298_Trello_Googlecloudnaturallanguage_Create_Triggered
...
- trelloApi (type only; no credential value stored)
- typeformApi (type only; no credential value stored)
